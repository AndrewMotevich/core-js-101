 ...
 *                                                    //  Ask her again.';
 */
function willYouMarryMe(/* isPositiveAnswer */ value) {
  const newPromise = new Promise((resolve, reject) => {
    if (value === true) resolve('Hooray!!! She said "Yes"!');
    else if (value === false) resolve('Oh no, she said "No".');
    if (typeof value !== 'boolean') reject(new Error('Wrong parameter is passed! Ask her again.'));
  });
  return newPromise;
}
